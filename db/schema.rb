...
ActiveRecord::Schema.define(version: 2020_10_12_183133) do
  ...
  create_table "covers", force: :cascade do |t|
    t.integer "game02_id", null: false
  ...
  add_foreign_key "covers", "game02s"
  add_foreign_key "pieces", "game02s"
  add_foreign_key "rules", "game02s"
end
